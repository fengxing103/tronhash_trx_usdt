...
return [
    ...
    'Configure the trc20 address of the game and transfer address'                                           => '配置游戏以及转账地址的trc20地址',
    'size play'                                           => '大小玩法',
    'Single and double play'                                           => '单双玩法',
    'double tail play'                                           => '双尾玩法',
    'pc10'                                           => 'pc10',
    'ratio'                                           => '费率',
    'payaddress'                                           => '转账地址',
    'payprivatekey'                                           => '转账地址私钥',
    'The trc20 address corresponding to the game the user transfers to'                                           => '用户转往的游戏对应的trc20地址',
    'The proportion of each game transfer to the superior'                                           => '每一笔游戏转账给上级的比例',
    'Wallet address (trc20) used to pay the winning players and their superiors'                                           => '用于支付中奖玩家及上级抽成的钱包地址(trc20)',
    'The private key corresponding to the transfer address'                                           => '转账地址对应的私钥',
